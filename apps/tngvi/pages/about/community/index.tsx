...
export default function Community({
  ...
  const RenderFilters = (filters: string[]) => {
    const menu = (
      <div className="flex flex-col justify-between md:flex-row md:w-3/4 lg:w-1/2 xl:w-1/3">
        <span>Filter:</span>
        ...
        <a
          ...
          className="text-bluegreen md:ml-2"
          onClick={(e) => {
            reset();
            e.preventDefault();
          }}
            ...
            >
              <a>
                <div className="flex flex-col mt-5">
                  <div>
                    {person.image ? (
                      ...
                      >
                        ...
                        <path
                          d="M 57.509 200 C 57.509 165.5 103.509 165.5 126.509 142.5 C 138.009 131 103.509 131 103.509 73.5 C 103.509 35.17 118.838 16 149.509 16 C 180.179 16 195.509 35.17 195.509 73.5 C 195.509 131 161.009 131 172.509 142.5 C 195.509 165.5 241.509 165.5 241.509 200"
                          style={{
                            stroke: 'rgb(141, 51, 210)',
                            strokeOpacity: 0.36,
                            strokeWidth: '7px',
                          }}
                        ></path>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-coated">
                      {person.name}
                    </h3>
