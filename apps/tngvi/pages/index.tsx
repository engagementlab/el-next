  ...
  return (
    <Layout>
        ...
        <div className="relative w-full mt-20 lg:max-h-screen overflow-clip">
          <div className="flex flex-col items-center">
            <div className="lg:mt-6 max-w-md text-center z-10">
              <h2 className="sm:text-xl lg:text-2xl font-semibold">
                Nearly every person in the U.S. will know someone who has been
                shot in their lifetime.
              </h2>
              <h1 className="text-xl lg:text-[2rem] font-bold text-purple mt-6">
      ...
      <div className="flex flex-col items-center w-full text-center">
        ...
        <p className="w-4/5 md:w-1/2 lg:w-full text-sm lg:text-lg mb-6 md:my-6 xl:mb-10 text-bluegreen font-semibold ">
          Through local and collaborative storytelling, we seek to inspire
          solutions and interrupt cycles of gun violence.
        </p>
      </div>
    </Layout>
  );
