      ...
      <section className="relative mt-6 lg:mt-0">
        <div className="flex justify-center bg-lavender text-white p-8">
          <div className="lg:ml-10 w-full xl:w-8/12">
            <h1 className="text-2xl lg:text-7xl font-semibold mb-7">
              {item.name}
            </h1>
            <DocumentRenderer
        ...
        <div className="flex justify-center bg-gradient-to-r from-clay via-pink to-wind text-white p-8">
          <div className="lg:ml-10 w-full xl:w-8/12">
            <h2 className="text-xl lg:text-6xl font-bold my-4 md:my-7">
              Books
            </h2>
            <DocumentRenderer
              document={item.books.document}
        ...
        <div className="flex justify-center bg-lavender text-white p-8">
          <div className="lg:ml-10 w-full xl:w-8/12">
            ...
            <DocumentRenderer
              document={item.selectWritings.document}
              componentBlocks={Blocks()}
              renderers={Doc()}
            />
          </div>
