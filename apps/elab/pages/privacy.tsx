  ...
  return (
    <Layout>
      <div className="container mt-14 mb-24 xl:mt-16 px-4 xl:px-8">
        ...
        <div>
          <p>
            The Engagement Lab at Emerson College (“Company”, “we”, “us”, or
            “our”) is committed to protecting your personal information and your
            ...
            <a href="mailto:engagementlab@emerson.edu">
              engagementlab@emerson.edu
            </a>
            .
          </p>
          <p>
            When you visit any of our web applications, use any of our mobile
            applications or games, or use our services, you trust us with your
          ...
          <p>
            ...
            website (such as{' '}
            <a href="https://elab.emerson.edu/">https://elab.emerson.edu/</a>),
            mobile application, ("Apps"), games, and/or any related services,
          ...
          <h3 className="my-4">1. WHAT INFORMATION DO WE COLLECT?</h3>
          ...
          <p>
            ...
            maintain the security and operation of our Services or Apps, and for
          ...
          <p>
            ...
            sponsored links). We will inform you about the source of information
            and the type of information and the type of information we have
            collected about you within a reasonable period after obtaining the
            personal data, but at the latest within one month.
          </p>
          <h3 className="my-4">2. HOW DO WE USE YOUR INFORMATION?</h3>
          <p>
          ...
          <p>
            ...
            evaluate and improve our Services or Apps, products, marketing and
          ...
          <p>
            ...
            beacons and pixels) to access or store information. All cookie data
            is anonymous.
          </p>
          <h3 className="my-4">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
          <p>
          ...
          <h3 className="my-4">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
          <p>
          ...
          <p>
            ...
            personal information to and from our Services or Apps is at your own
            risk. You should only access the services within a secure
            environment.
          </p>
          <h3 className="my-4">7. DO WE COLLECT INFORMATION FROM MINORS?</h3>
          <p>
          ...
          <p>
            ...
            minor and consent to such minor dependent’s use of the Services or
            Apps. If we learn that personal information from users less than 18
          ...
          <h3 className="my-4">8. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
          <p>
          ...
          <p>
            ...
            interest-based advertising by advertisers on our Services or Apps
            visit{' '}
          ...
          <h3 className="my-4">9. CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
          <p>
          ...
          <p>
            ...
            on the Services or Apps, but please be aware that the data may not
            be completely or comprehensively removed from our systems.
          </p>
          <h3 className="my-4">11. DO WE MAKE UPDATES TO THIS POLICY?</h3>
          <p>
          ...
          <p>
            Engagement Lab at Emerson College, Attn: Lead Developer, 120
            Boylston Street, Boston, MA 02116, United States
          </p>
        </div>
      </div>
    </Layout>
