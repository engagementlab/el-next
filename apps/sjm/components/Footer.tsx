    ...
    return (
        <div className='w-full flex justify-center'>
          <div className='w-full xl:w-1/2 text-center'>
            <h2 className='font-semibold font-sans text-3xl text-blossom mb-6'>Social Justice + Media Symposium Partners</h2>
            <div className='flex flex-col md:flex-row md:flex-wrap justify-around items-center'>
              ...
              <Image id="emerson-logo" alt="Emerson College logo" imgId='sjm/logos/emerson' width={150}
                transforms='f_auto,dpr_auto' className='my-5' />
              <Image id="fiu-logo" alt="Florida International University logo" imgId='sjm/logos/FIU' width={248}
                transforms='f_auto,dpr_auto' />
              <Image id="ua-logo" alt="The University of Arizona logo" imgId='sjm/logos/ua' width={146}
                transforms='f_auto,dpr_auto' />
              <div className='basis-full h-0'></div>
              <Image id="um-logo" alt="University of Miami logo" imgId='sjm/logos/um' width={146}
                transforms='f_auto,dpr_auto' />
              <svg aria-label='Engagement Lab logo' width="180" height="150" fill="none" viewBox="0 0 424 150">
                ...
                <path fill="#00AB9E" fillRule="evenodd"
                  ...
                  clipRule="evenodd" />
                <path fill="#F72923" fillRule="evenodd" d="M418.989 32.682v7.736h-27.933V1.742h7.605v30.94h20.328z"
                  clipRule="evenodd" />
              ...
              <div className='basis-full h-0'></div>
              <Image id="mfc-logo" alt="Mediaforchange.org logo" imgId='sjm/logos/mfc' width={408}
                transforms='f_auto,dpr_auto' />
              <Image id="rwu-logo" alt="Roger Williams University logo" imgId='sjm/logos/rwu' width={211}
                transforms='f_auto,dpr_auto' />
              <div className='basis-full h-0'></div>
              <Image id="slz-logo" alt="Salzburg Global Seminar logo" imgId='sjm/logos/salzburg' width={211}
                transforms='f_auto,dpr_auto' />
              <Image id="lau-logo" alt="Lebanese American University logo" imgId='sjm/logos/lau' width={211}
                transforms='f_auto,dpr_auto' />
              <div className='basis-full h-0'></div>
              <Image id="ivoh-logo" alt="IVOH logo" imgId='sjm/logos/ivoh' width={211} transforms='f_auto,dpr_auto' />
              <Image id="jword-logo" alt="JWord logo" imgId='sjm/logos/jword' width={211}
                transforms='f_auto,dpr_auto' />
              <Image id="nsc-logo" alt="Nevada State University logo" imgId='sjm/logos/nsc' width={211}
                transforms='f_auto,dpr_auto' />
            </div>
          </div>
        </div>
